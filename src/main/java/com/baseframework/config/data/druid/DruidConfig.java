package com.baseframework.config.data.druid;

import com.alibaba.druid.pool.DruidDataSource;
import com.alibaba.druid.support.http.StatViewServlet;
import com.alibaba.druid.support.http.WebStatFilter;
import com.baseframework.config.data.GlobalDataSource;
...
public class DruidConfig {
    ...
    public DataSource druidDataSource() {
        ...
        dataSource.setUrl(globalDataSource.getUrl());
        dataSource.setUsername(globalDataSource.getUsername());
        dataSource.setPassword(globalDataSource.getPassword());
        dataSource.setDriverClassName(globalDataSource.getDriverClassName());
        return dataSource;
    }
